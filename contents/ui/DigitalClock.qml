...
MouseArea {
    ...
    states: [
        State {
            ...
            PropertyChanges {
                ...
                // Keep the original compact bounding box: together with the
                // descender offset below, this optically centers the equal-sized rows.
                ...
                // Same-size customization: the stacked date matches the time.
        ...
        State {
            ...
            PropertyChanges {
                ...
                // The top margin is intentionally excluded because the optical
                // descender offset already compensates for it.
                ...
                // Same-size customization: keep the date exact and wrap instead of shrinking.
                dateLabel.height: dateLabel.contentHeight
                dateLabel.fontSizeMode: Text.FixedSize
                dateLabel.verticalAlignment: Text.AlignTop
                dateLabel.font.pixelSize: timeLabel.font.pixelSize
                dateLabel.elide: Text.ElideNone
                dateLabel.wrapMode: Text.WrapAtWordBoundaryOrAnywhere
    ...
    // Compensate for the typeface descenders so the visible text is optically centered.
    FontMetrics {
        id: timeFontMetrics
    ...
    */
    Item {
        ...
        anchors.verticalCenterOffset: -(timeFontMetrics.descent + dateFontMetrics.descent) / 2
    ...
    PlasmaComponents.Label {
        ...
        // Keep the automatic clock compact while respecting explicit user sizes.
        font.pixelSize: Plasmoid.configuration.autoFontAndSize ? main.pointToPixel(9) : main.pointToPixel(Plasmoid.configuration.fontSize)
